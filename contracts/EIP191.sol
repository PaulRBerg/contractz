...
contract EIP191 {
    ...
    function submitMessage(bytes message, uint8 v, bytes32 r, bytes32 s)
    public
    {
        bytes memory encoding = abi.encodePacked(byte(0x19), byte(0), address(this), message);
    ...
    returns (bytes32 transactionHash)
    {
        ...
        transactionHash = keccak256(abi.encodePacked(byte(0x19), byte(0), this, destination, value, data, nonce));
